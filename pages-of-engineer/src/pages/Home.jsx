    ...
    return (
      <div className="min-h-screen font-sans bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
          ...
          {/* LEFT IMAGE BLOCK */}
          <div className="bg-cover bg-center min-h-[500px]" style={{ backgroundImage: "url('/images/desk-horizontal.jpeg')" }}></div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white shadow-md p-4 flex items-start gap-4 border-l-4 border-rose-300">
              <img src="/images/ghibliMe.jpeg" alt="Author" className="w-16 h-16 rounded-full object-cover" />
              <div>
                <h3 className="font-semibold">Merhaba, ben Merve. Merak ettiklerimi, ürettiklerimi ve öğrendiklerimi burada paylaşıyorum.</h3>
                <p className="text-sm text-gray-600">Bu blogda biraz merak ettiklerim, biraz denediklerim, bolca da “üretme hali” var.</p>
                <a href="#" className="text-rose-500 text-sm font-medium mt-1 inline-block">Hakkımda daha fazla...</a>
              </div>
            </div>
  
            <div className="bg-cover bg-center h-64 relative" style={{ backgroundImage: "url('/images/desk1.jpeg')" }}>
          ...
          {/* RIGHT SECTION */}
          <div className="flex flex-col gap-6">
            <div className="bg-cover bg-center h-64" style={{ backgroundImage: "url('/images/ghibliMe.jpeg')" }}>
