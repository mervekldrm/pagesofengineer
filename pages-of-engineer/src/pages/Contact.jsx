...
const Contact = () => {
  const coffeeAnim = useLottieFromPublic(process.env.PUBLIC_URL + '/images/coffee.json');
  const bookAnim = useLottieFromPublic(process.env.PUBLIC_URL + '/images/book.json');
  const laptopAnim = useLottieFromPublic(process.env.PUBLIC_URL + '/images/laptop.json');
